...
/**
 * Définit les propriétés de style pour les boutons
 */
export type ButtonStyleProps = {
  /** Couleur du bouton: accent, success ou destructive */
  color?: Color;
  /** Taille du bouton: sm, md ou lg */
  size?: Size;
  /** Indique si le bouton est en état de chargement personnalisé */
  isCustomPending?: boolean;
  /** Indique si le bouton est uniquement une icône */
  isIconOnly?: boolean;
  /** Texte affiché pendant l'état de chargement */
  pendingLabel?: string;
...
/**
 * Bouton principal avec support pour différentes variantes et états
 *
 * @example
 * <Button>Cliquez-moi</Button>
 *
 * @example
 * <Button variant="outline" color="destructive">Supprimer</Button>
 */
...
/**
 * Bouton à bascule qui peut être activé ou désactivé
 *
 * @example
 * <ToggleButton>Mode sombre</ToggleButton>
 */
export function ToggleButton(
  props: RACToggleButtonProps & ButtonStyleProps & { tooltip?: React.ReactNode }
) {
...
export function ToggleButtonGroup({
  ...
  /** Affiche les boutons en ligne avec des bordures partagées */
  inline?: boolean;
...
/**
 * Groupe de boutons standard avec des styles cohérents
 */
