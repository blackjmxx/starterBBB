...
/**
 * Groupe d'entrées avec styles cohérents
 *
 * @example
 * <InputGroup>
...
export function InputGroup({
  ...
  /** Si true, les éléments seront affichés en ligne */
  inline?: boolean;
}) {
  return (
    <RACGroup
...
/**
 * Élément d'accompagnement pour les champs de saisie
 *
 * @example
 * <InputGroup>
 *   <InputAddon>https://</InputAddon>
...
/**
 * Séparateur visuel entre les éléments d'un groupe d'entrées
 */
...
/**
 * Groupe d'entrées avec disposition en grille
 *
 * @example
 * <InputGroups>
