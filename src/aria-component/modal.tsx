...
/**
 * Type de modale (standard ou tiroir)
 */
type ModalType =
...
type ModalProps = Omit<RACModalOverlayProps, "className"> & {
  ...
  /** Classes CSS personnalisées pour différentes parties de la modale */
  classNames?: {
...
/**
 * Modale accessible avec animations et support pour différents placements
 *
 * @example
 * <DialogTrigger>
 ...
 *   <Modal>
 *     <Dialog>
 *       <Heading>Titre de la modale</Heading>
 *       <Content>Contenu de la modale</Content>
 *       <ButtonGroup>
 ...
 *   <Modal drawer placement="right">
 *     <Dialog>
 *       <Heading>Tiroir latéral</Heading>
 *       <Content>Contenu du tiroir</Content>
 *     </Dialog>
 *   </Modal>
 * </DialogTrigger>
 */
