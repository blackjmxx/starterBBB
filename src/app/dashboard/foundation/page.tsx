...
export default function FoundationPage() {
  ...
  const [activeDashboardLayout, setActiveDashboardLayout] =
    useState("DefaultLayout");
  ...
  const allComponents = Object.values(componentGroups).reduce(
    (acc, group) => ({
      ...acc,
      ...group,
    }),
  ...
  const ActiveComponent = allComponents[
    activeComponent as keyof typeof allComponents
  ] as React.ComponentType<any>;
  const ActiveDashboardLayout = componentGroups["Dashboard Layouts"][
    activeDashboardLayout as keyof (typeof componentGroups)["Dashboard Layouts"]
  ] as React.ComponentType<any>;
        ...
        {activeDashboardLayout ? (
          <ActiveDashboardLayout>
            <div className="p-4 bg-gray-100 dark:bg-gray-700 rounded-lg">
              ...
              <p>
                This is a placeholder for the dashboard content. The layout
                you've selected is applied to this content.
              </p>
            </div>
          </ActiveDashboardLayout>
        ) : (
